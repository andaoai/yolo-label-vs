...
[![VS插件市场版本](https://img.shields.io/badge/VS_Marketplace-v0.0.90-blue?link=https://marketplace.visualstudio.com/items?itemName=andaoai.yolo-labeling-vs)](https://marketplace.visualstudio.com/items?itemName=andaoai.yolo-labeling-vs)
